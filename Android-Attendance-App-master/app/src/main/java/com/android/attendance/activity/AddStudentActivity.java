...
public class AddStudentActivity extends Activity {
	...
	private String[] branchString = new String[] { "Аспирантура", "Магистратура"};
	private String[] yearString = new String[] {"1","2","3", "4", "5"};
		...
		registerButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (TextUtils.isEmpty(first_name)) {
					textFirstName.setError("введите имя");
				}

				else if (TextUtils.isEmpty(last_name)) {
					textLastName.setError("введите фамилию");
				}
				else if (TextUtils.isEmpty(phone_no)) {
					textcontact.setError("введите номер телефона");
				}

				else if (TextUtils.isEmpty(address)) {
					textaddress.setError("введите адрес");
				}				
				else { 
					...
					Toast.makeText(getApplicationContext(), "Студент добавлен", Toast.LENGTH_SHORT).show();
