		...
		registerButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (TextUtils.isEmpty(first_name)) {
					...
					textcontact.setError("введите имя пользователя");
				}
				else if (TextUtils.isEmpty(passWord)) {
					textaddress.setError("введите пароль");
				}				
				else { 
					...
					Toast.makeText(getApplicationContext(), "Преподаватель добавлен", Toast.LENGTH_SHORT).show();
