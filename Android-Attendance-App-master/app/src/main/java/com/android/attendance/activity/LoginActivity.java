...
public class LoginActivity extends Activity {
	...
	String userrole;
	private String[] userRoleString = new String[] { "Администратор", "Преподаватель"};
		...
		login.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(userrole.equals("Администратор"))
				{
					...
					{
						username.setError("Не верное имя пользователя");
					}
					else if(TextUtils.isEmpty(pass_word))
					{
						password.setError("Веедите пароль");
					}
					else
					{
				...
				else
				{
					...
					{
						Toast.makeText(getApplicationContext(), "Ошибка взода", Toast.LENGTH_SHORT).show();
					}
				}
